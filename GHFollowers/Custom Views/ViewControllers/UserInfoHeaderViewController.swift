...
class UserInfoHeaderViewController: UIViewController {
    ...
    let avatarImageView = NTAvatarImageView(frame: .zero)
    let usernameLabel = NTTitleLabel(textAlignment:  .left, fontSize: 34)
    let nameLabel = NTSecondaryTitleLabel(fontSize: 18)
    let locationImageView = UIImageView()
    let locationLabel = NTSecondaryTitleLabel(fontSize: 18)
    let bioLabel = NTBodyLabel(textAlignment: .left)
    ...
    func layoutUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            locationImageView.bottomAnchor.constraint(equalTo: avatarImageView.bottomAnchor, constant: 8),
            ...
            bioLabel.leadingAnchor.constraint(equalTo: avatarImageView.trailingAnchor),
