...
class NTAlertViewController: UIViewController {
    
    let containerView = UIView()
    let titleLabel = NTTitleLabel(textAlignment: .center, fontSize: 20)
    let bodyLabel = NTBodyLabel(textAlignment: .center)
    let actionButton = NTButton(backgroundColor: .systemPink, title: "Ok")
